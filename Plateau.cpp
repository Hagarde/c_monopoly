...
void Plateau::creerCases() {
	...
	Carte* pile_carte_communaute = Plateau::initialisation_cartes_communaute();
	...
	Carte* pile_carte_chance = Plateau::initialisation_cartes_chance();
    ...
    // initialisation autres cases

    liste_couleur = new couleur[9];
...
Carte* Plateau::initialisation_cartes_chance(){
	...
	pile_carte_chance[0] = Carte("Allez directement sur la Case Départ",0,0,0,getCase(0));
	...
	pile_carte_chance[2] = Carte("Rendez-vous au Boulevard de la Villette",0,0,0,getCase(11)); // NULL à remplacer par case 11 du plateau
	...
	pile_carte_chance[5] = Carte("Rendez-vous à la rue Henri Martin ",0,0,0,getCase(24));// dernier null à remplacer par la case 24 du plateau
	pile_carte_chance[6] = Carte("Rendez-vous à la gare de Lyon",0,0,0,getCase(15)); // replace null => 15
	...
	pile_carte_chance[13] = Carte("Rendez-vous à la Rue de la Paix",0,0,0,getCase(40)); // NULL à remplacr par #40
...
Carte* Plateau::initialisation_cartes_communaute(){
	...
	pile_carte_communaute[7] = Carte("Retournez à Boulevard de Belleville",0,0,0,getCase(1));
	pile_carte_communaute[8] = Carte("Aller en prison",0,0,0,getCase(10));
	pile_carte_communaute[9] = Carte("Placez vous sur la Case Départ",0,0,0,getCase(0));
